...
public class Calculator extends JFrame implements ActionListener    //Creating the main class
{
	...
	public Calculator()   // Constructor
	{
		...
		clock=new Clock();     //Creating the object of Class Clock
		...
		keyPanel=new JPanel(new GridLayout(4,5,2,2));   //Key Panel && Number Buttons
